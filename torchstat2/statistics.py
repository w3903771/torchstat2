...
from torchstat2 import ModelHook
from collections import OrderedDict
from torchstat2 import StatTree, StatNode, report_format
    ...
    for leaf_module_name, leaf_module in leaf_modules.items():
        ...
        for i in range(len(names)):
            ...
            if i == len(names) - 1:  # leaf module itself
                ...
                # Add module type information for better naming
                node.module_type = type(leaf_module).__name__
...
class ModelStat(object):
    def __init__(self, model, input_size, query_granularity=1):
        ...
        assert isinstance(input_size, (tuple, list)) and len(input_size) >= 1
        self._model = model
    ...
    def _analyze_model(self):
        ...
        try:
            ...
            # Clean up the hook to avoid conflicts in subsequent calls
            del model_hook
